...
@Component
public class ModifyFileAccessEventsFormatter extends ResultFormatter {
    ...
    public void update(Observable o, Object arg) {
        ...
        while (var4.hasNext()) {
            ...
            logConverterService.handleFileEvent(ServiceUtil.extractLogEntryFromRDFTruple(t), FileAccessType.Created_Modified);
        }
    }
}