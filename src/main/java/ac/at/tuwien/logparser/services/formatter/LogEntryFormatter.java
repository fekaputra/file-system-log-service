...
import ac.at.tuwien.logparser.entities.LogEntry;
...
@Component
public class LogEntryFormatter extends ResultFormatter {
    ...
    public void update(Observable o, Object arg) {
        ...
        while (var4.hasNext()) {
            ...
            LogEntry entry = ServiceUtil.extractLogEntryFromRDFTruple(t);
            logConverterService.handleLogRecord(entry);
        }
    }
}